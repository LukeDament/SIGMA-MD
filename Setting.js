...
global.github    = 'https://github.com/LukeDament/SIGMA-MD' ;
...
global.owner = process.env.OWNER_NUMBER  || '923429447356' ;  // ADD YOUR NUMBER WITHOUT +
...
global.sudo  =  process.env.SUDO || "923429447356" ;          // DON'T REMOVE
global.mztit = process.env.MZTIT ||"𝐌𝐫_𝐇𝐢𝐝𝐝𝐞𝐧𝐗㋡",               // ADD YOUR TITLE, ONE WORD WILL BE MORE BETTER
global.gurl  = 'https://www.youtube.com/@ibadullah2094' ; 
...
module.exports = {
  ...
  botname: process.env.BOT_NAME       || 'ᴍʀ_ʜɪᴅᴅᴇɴx-ᴍᴅ',         // ADD YOUR BOT NAME
  ownername:  process.env.OWNER_NAME  || `ᴍʀ_ʜɪᴅᴅᴇɴx`, // ADD YOUR NAME
  ...
  //==============================[WHAT'SAPP FEATURES]==============================
  author:  process.env.PACK_AUTHER  || '@𝐌𝐫_𝐇𝐢𝐝𝐝𝐞𝐧𝐗 ²⁰²⁴',      // ADD YOUR STICKER AUTHOR NAME
  ...
  packname:  process.env.PACK_NAME  || "+𝟗𝟐𝟑𝟒𝟐𝟗𝟒𝟒𝟕𝟑𝟓𝟔" ,          // ADD YOUR STICKER PACKNAME
